...
export default function ArtCollectionReport() {
  ...
  const [statuses, setStatuses] = useState(["On Display", "In Storage", "On Loan", "Under Restoration", "Deaccessioned"]);
    ...
    <div className="data-section">
        ...
        <table className="data-table">
            ...
            {currentRows.map((artwork, idx) => (
                ...
                <td>
                    {artwork.gallery_active === 1 ? "🟢 Active" : "⚪ Inactive"}
                </td>
                </tr>
            ))}
            </tbody>
